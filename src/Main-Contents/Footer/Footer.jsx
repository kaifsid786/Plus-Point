    ...
    <>
      ...
      >
        <div className="main-footer">
          <div className="foot-row-1">
            <div className="foot-col-1">
              ...
              <p className="foot-para">
                Plus Point Locks is here to make your homes a merrier feel. Our
                hardware collection provides you with the best of options, at
                the most affordable prices! Don’t believe us? Have a look for
                yourself!
              </p>
          ...
          <div className="foot-row-3">©Plus Point all rights reserved</div>
        </div>
      </div>
    </>
  );
