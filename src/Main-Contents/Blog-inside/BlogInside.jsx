      ...
      <div className="process">
        ...
        <div className="blog-comments">
          ...
          <div className="comment-profile">
            ...
            {/* your comment */}
            <div style={{ marginTop: "3rem" }} className="share-cmt">
              <Paper
                component="form"
                sx={{
                  p: "2px 4px",
        ...
        <div style={{ marginTop: "1rem" }} className="rel-blog">
          ...
          <div style={{ marginTop: "1.5rem" }} className="main-homeNews">
            <div
              style={{ justifyContent: "center", gap: "2rem", display: "flex" }}
            ...
            >
              <div className="homeNews-content h-c-b">
                ...
                <div className="b-info">
                  ...
                  <br />
                  <div style={{textAlign:'left',color:'rgba(96, 96, 96, 1)'}}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy </div>
                </div>
