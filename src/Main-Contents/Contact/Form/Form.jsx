              ...
              <div className="form-wrapper">
                 <div className="form-left">
                   <div className="form-left-content">
                        ...
                        <div className="main-contactBox" onMouseEnter={()=>setChImg1(true)}
                         onMouseLeave={()=>setChImg1(false)} onClick={()=>{
                              ...
                              <div className="main-contactBox" onMouseEnter={()=>setChImg2(true)} 
                              onMouseLeave={()=>setChImg2(false)} onClick={()=>{
                              ...
                              <div className="main-contactBox" onMouseEnter={()=>setChImg3(true)} 
                              onMouseLeave={()=>setChImg3(false)} onClick={()=>{
                              ...
                              <div className="main-contactBox" onMouseEnter={()=>setChImg4(true)} 
                              onMouseLeave={()=>setChImg4(false)} onClick={()=>{
                              ...
                              <div className="main-contactBox" onMouseEnter={()=>setChImg5(true)} 
                              onMouseLeave={()=>setChImg5(false)} onClick={()=>{
