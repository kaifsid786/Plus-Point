...
export default function Form2(props) {
  ...
  const title=["MORTISE LOCK SET","DOOR PULL HANDLES","ALDROP DOOR KITS","MAIN DOOR LOCKS","CABINET LOCKS"]
  const title2=["CABINET HANDLES","DOOR DECORATIVE ACCESSORIES","DOOR HINGES","DOOR CLOSERS"];
           ...
           <div className="main-form2">
               <div className="form2-wrapper">
                   <div className="form2-title">
                    ...
                    <div className="form2-info"> Tap multiple categories to select them. </div>
